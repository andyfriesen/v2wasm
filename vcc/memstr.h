...
public:
	int compare(void* c)
		{ return ((memorystream_t*)c)->F_size > F_size; }

	enum origin_t { soFromBeginning, soFromCurrent, soFromEnd };

	memorystream_t()
	: F_hunksize(256), F_capacity(0), F_data(NULL), F_size(0), F_position(0)
		{ }
	...
	const void* getdata() const
		{ return F_data; }
	const void* getposdata() const
		{ return F_data + F_position; }
	...
	unsigned long gethunksize() const
		{ return F_hunksize; }
