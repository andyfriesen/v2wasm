...
void vc_RotScale()
{
    ...
    if (!lucentmode)
     gfx.RotScale(x,y,width,length,angle*3.14159/180.0,scale/1000.0,(byte*)ptr);
    else
     gfx.RotScaleLucent(x,y,width,length,angle*3.14159/180.0,scale/1000.0,(byte*)ptr,lucentmode);
}
