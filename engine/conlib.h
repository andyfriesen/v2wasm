...
static void Conlib_Map() {
    ...
    case 1:
        ...
        // sprintf(strbuf,"MAP stats for �%s~ - �%d~ layers",mapname,numlayers);
        // Console_Printf(strbuf);
        Console_Printf(va("MAP stats for %s - %d layers", mapname, numlayers));

        // sprintf(strbuf,"Base dimensions �%d~ x �%d~", layer[0].sizex,
        // layer[0].sizey);
        // Console_Printf(strbuf);
        Console_Printf(
        ...
        // sprintf(strbuf,"�%d~ active zones.",numzones);
        // Console_Printf(strbuf);
        Console_Printf(va("%d active zones.", numzones));

        Console_Printf("{||||||||||||||||||||}");

        // sprintf(strbuf,"VSP file: �%s~",vspname); Console_Printf(strbuf);
...
static void Conlib_Entity() {
    ...
    case 2: {
        ...
        // sprintf(strbuf,"Desc: �%s~", entity[i].desc); Console_Printf(strbuf);
        Console_Printf(va("Desc: %s", entity[n].desc));
        // sprintf(strbuf,"tx: �%d~ ty: �%d~", entity[i].tx, entity[i].ty);
        // Console_Printf(strbuf);
...
static void Conlib_CurPos() {
    switch (Con_NumArgs()) {
    case 1:
        // sprintf(strbuf,"xwc: �%d~ ywc: �%d~", player->x, player->y);
        // Console_Printf(strbuf);
        Console_Printf(va("xwc: %d ywc: %d", player->x, player->y));
        // sprintf(strbuf,"xtc: �%d~ ytc: �%d~", player->x>>4, player->y>>4);
        // Console_Printf(strbuf);
...
static void Conlib_PlayerSpeed() {
    ...
    switch (Con_NumArgs()) {
    case 1:
        // sprintf(strbuf,"speed is is �%d~", player->speed);
        // Console_Printf(strbuf);
...
static void Conlib_ShowZones() {
    switch (Con_NumArgs()) {
    case 1:
        // sprintf(strbuf,"showzones is �%d~", showzone);
        // Console_Printf(strbuf);
