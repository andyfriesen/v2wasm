...
/*
    ...
    <tSB> Dec 22nd.
    Replaced ::c_str method with operator const char* (made it port to VERGE
   easier)
*/
...
string_k string_k::left(int count) const { return mid(0, count); }
...
int string_k::length() const { return strlen(F_data); }
