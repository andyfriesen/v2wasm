...
{
	return (gfx.XRes() -2)/Font_GetWidth(0);
}
...
/*		LFB_BlitWrap(
	...
	} while (--row && y+Font_GetLength(0)<gfx.YRes() && iter != lines->head());
...
void V2SE_Key(int key)
{
    switch (key)
     {
      case DIK_ESC:     editor_processing=0;    break;

      case DIK_UP:      V2SE_MoveUp();          break;
      case DIK_DOWN:    V2SE_MoveDown();        break;
      case DIK_LEFT:    V2SE_MoveLeft();        break;
      case DIK_RIGHT:   V2SE_MoveRight();       break;

      case DIK_HOME:    V2SE_Home();            break;
      case DIK_END:     V2SE_End();             break;

      case DIK_PGUP:    V2SE_PageUp();          break;
      case DIK_PGDN:    V2SE_PageDown();        break;

      case DIK_TAB:     V2SE_Tab();             break;
      case DIK_ENTER:   V2SE_Enter();           break;

//      case DIK_DEL:     V2SE_Delete();          break;
      case DIK_BACK:    V2SE_Backspace();       break;
    
      case DIK_F12:     V2SE_Save();            break;
